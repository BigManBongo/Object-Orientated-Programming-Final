...
{
    public class BackStroke : Event //derived class of Event
    {
        ...
        public BackStroke(int EventNo, string Venue, string EventDateTime, double Record, string EventType, int Distance, double WinningTime) : base(EventNo, Venue, EventDateTime, Record)
        {
        ...
        public BackStroke(int EventNo, int VenueID, string EventDateTime, double Record, string EventType, int Distance, double WinningTime) : base(EventNo, VenueID, EventDateTime, Record)
        {
            this.EventType = EventType;
            this.Distance = Distance;
            this.WinningTime = WinningTime;
        ...
        public override string ToString() //returns a string of all the details of the backstroke event
        {
