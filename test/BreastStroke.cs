...
{
    public class BreastStroke : Event //derived class of Event
    {
        ...
        public BreastStroke(int EventNo, string Venue, string EventDateTime, double Record, string EventType, int Distance, double WinningTime) : base(EventNo, Venue, EventDateTime, Record)
        {
        ...
        public BreastStroke(int EventNo, int VenueID, string EventDateTime, double Record, string EventType, int Distance, double WinningTime) : base(EventNo, VenueID, EventDateTime, Record)
        {
            this.EventType = EventType;
            this.Distance = Distance;
            this.WinningTime = WinningTime;
        ...
        public override string ToString() //returns a string of all the details of the breaststroke event
        {
